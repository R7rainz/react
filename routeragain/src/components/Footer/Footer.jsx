  ...
  return (
    <footer className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white">
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              ...
              <ul className="font-medium">
                ...
                <li>
                  <Link to="/testing" className="hover:underline hover:text-indigo-200">
                    About
                  </Link>
                </li>
              </ul>
        ...
        <hr className="my-6 border-indigo-400 sm:mx-auto lg:my-8" />
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm sm:text-center">
            © 2023
            <a href="https://bento.me/rainz/" className="hover:underline hover:text-indigo-200 ml-1">
              ronakkamboj
            </a>
            . All Rights Reserved.
          </span>
